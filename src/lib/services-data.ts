...
export const SERVICE_AREA_LIST = [
  ...
  "Ocean County, NJ (Toms River, Brick, Lakewood)",
  "Atlantic County, NJ (Atlantic City, Egg Harbor Township, Galloway)",
  "Cumberland County, NJ (Vineland, Bridgeton)",
  "Cape May County, NJ (Cape May, Wildwood, Ocean City)",
  "Salem County, NJ (Salem, Pennsville)",

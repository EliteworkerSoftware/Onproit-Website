...
export default function AdminBlogDraftsPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-500">
        Posts the content agent wrote for your target keywords. Nothing is on the site until you publish it.
      </p>
      ...
      <div className="mt-6 space-y-4">
        {!drafts ? (
          ...
          <div className="rounded-xl border border-dashed border-gray-300 bg-white py-16 text-center">
            ...
            <p className="mt-3 font-semibold text-gray-700">No drafts waiting</p>
            <p className="mt-1 text-sm text-gray-500">
